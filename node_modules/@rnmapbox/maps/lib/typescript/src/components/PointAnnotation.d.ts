...
declare const PointAnnotation_base: {
    new (...args: any[]): {
        ...
        _runNativeMethod<RefType, ReturnType = import("../utils").NativeArg>(methodName: string, nativeRef: RefType | undefined, args?: import("../utils").NativeArg[]): Promise<ReturnType>;
        context: unknown;
